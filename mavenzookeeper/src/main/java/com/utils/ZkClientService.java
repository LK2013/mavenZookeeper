...
public class ZkClientService {
    ...
    public ZkClientService() throws Exception {
        this("192.168.194.128:2181",5000,"zookeeper",null);
    }
    ...
    public ZkClientService(String zkAddr, int timeOut, String namespace,ACL acl) throws Exception{
        this.zkAddr = zkAddr;
        if (timeOut > 0) {
    ...
    public ZkClientService addAuth(String authSchema, String authInfo)
            throws Exception {
        synchronized (ZkClientService.class) {
